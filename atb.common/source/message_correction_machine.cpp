...
inline void atb::common::message_correction_machine::trim_internal_buffer_left(
...
inline void atb::common::message_correction_machine::copy_to_output() noexcept {
    memcpy(out_buffer, internal_buffer, network_message_length);
    out_size = network_message_length;
}

atb::common::message_correction_machine::message_correction_machine() noexcept
    : delim(0), out_size(0) {
    memset(internal_buffer, 0, internal_buffer_capacity);
}

void atb::common::message_correction_machine::consume(const byte* data,
...
void atb::common::message_correction_machine::process() noexcept {
...
const void* atb::common::message_correction_machine::data() const noexcept {
    return out_buffer;
}

unsigned int atb::common::message_correction_machine::length() const noexcept {
    return out_size;
}
